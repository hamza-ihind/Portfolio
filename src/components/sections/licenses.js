...
const Licenses = ({ data }) => {
  ...
  return (
    <StyledContainer id="licenses" ref={revealContainer}>
      <Heading>My Licenses & Certifications</Heading>
      <StyledTabs>
        <StyledTabList role="tablist" aria-label="License tabs" onKeyDown={e => onKeyPressed(e)}>
          {data &&
            data.map(({ node }, i) => {
